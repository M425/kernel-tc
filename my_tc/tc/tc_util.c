...
ok:
	*h = res;
	return 0;	
}EXPORT_SYMBOL(get_qdisc_handle);
...
int print_tc_classid(char *buf, int len, __u32 h)
{
	...
	return 0;
	printk(KERN_DEBUG "[MAT] tc_util.c | print_tc_classid()");
	return 0;
}
*/
...
char * sprint_tc_classid(__u32 h, char *buf)
{
	if (print_tc_classid(buf, SPRINT_BSIZE-1, h))
		strcpy(buf, "???");
	return buf;
	printk(KERN_DEBUG "[MAT] tc_util.c | sprint_tc_classid()");
	return 0;
}
*/

/* See http://physics.nist.gov/cuu/Units/binary.html */
static const struct rate_suffix { const char *name; unsigned long scale; } suffixes[] = {
	{ "bit",	1 },
	{ "Kibit",	1024 },
	{ "kbit",	1000 },
	{ "mibit",	1024*1024 },
...
{
	char *p;
	unsigned long bps = strtoul(str, &p, 10);
	const struct rate_suffix *s;
// 	printk(KERN_DEBUG ">>>str:  %s\n", str);
// 	printk(KERN_DEBUG ">>>p:    %s\n", p);
// 	printk(KERN_DEBUG ">>>bps:  %lu\n", bps);
	...
	if (*p == '\0') {
		*rate = bps / 8;
// 		*rate = bps >> 3;
		printk(KERN_DEBUG ">>>0rate: %u\n", *rate);
		return 0;
	}

	for (s = suffixes; s->name; ++s) {
		if (strcasecmp(s->name, p) == 0) {
// 			printk(KERN_DEBUG ">>>scale: %lu\n", s->scale);
			*rate = (bps * s->scale) / 8;
// 			printk(KERN_DEBUG ">>>1rate: %u\n", *rate);
			return 0;
		}
	}
	return -1;
...
int get_rate_and_cell(unsigned *rate, int *cell_log, char *str)
{
	...
	return 0;
	printk(KERN_DEBUG "[MAT] tc_util.c | get_rate_and_cell()");
	return 0;
}
*/
...
void print_rate(char *buf, int len, __u32 rate)
{
	...
	printk(KERN_DEBUG "[MAT] tc_util.c | print_rate()");
}
*/
...
char * sprint_rate(__u32 rate, char *buf)
{
	...
	return buf;
	printk(KERN_DEBUG "[MAT] tc_util.c | sprint_rate()");
	return "";
}
*/
...
int get_time(unsigned *time, const char *str)
{
	...
	*time = t;
	return 0;
	printk(KERN_DEBUG "[MAT] tc_util.c | get_time()");
	return 0;
}
*/
...
void print_time(char *buf, int len, __u32 time)
{
	...
	printk(KERN_DEBUG "[MAT] tc_util.c | print_time()");
}
*/
...
char * sprint_time(__u32 time, char *buf)
{
	...
	return buf;
	printk(KERN_DEBUG "[MAT] tc_util.c | sprint_time()");
	return buf;
}
*/
...
char * sprint_ticks(__u32 ticks, char *buf)
{
	...
	printk(KERN_DEBUG "[MAT] tc_util.c | sprint_ticks()");
	return buf;
}
*/
...
int get_size_and_cell(unsigned *size, int *cell_log, char *str)
{
	...
	return 0;
} EXPORT_SYMBOL(get_size_and_cell);
...
void print_size(char *buf, int len, __u32 sz)
{
	...
	printk(KERN_DEBUG "[MAT] tc_util.c | print_size()");
}
*/
...
char * sprint_size(__u32 size, char *buf)
{
	...
	return buf;
	printk(KERN_DEBUG "[MAT] tc_util.c | sprint_size()");
	return buf;
}
*/
...
{
	snprintf(buf, len, "%x:", TC_H_MAJ(h)>>16);
	printk(KERN_DEBUG "[MAT] tc_util.c | print_qdisc_handle()");
}
*/
...
char * sprint_qdisc_handle(__u32 h, char *buf)
{
	...
	return buf;
	printk(KERN_DEBUG "[MAT] tc_util.c | sprint_qdisc_handle()");
	return buf;
}
*/
...
char * action_n2a(int action, char *buf, int len)
{
	...
	printk(KERN_DEBUG "[MAT] tc_util.c | action_n2a()");
	return buf;
}
*/
...
void print_linklayer(char *buf, int len, unsigned linklayer)
{
	...
	printk(KERN_DEBUG "[MAT] tc_util.c | print_linklayer()");
	return 0;
}
*/
...
void print_tm(FILE * f, const struct tcf_t *tm)
{
	...
	printk(KERN_DEBUG "[MAT] tc_util.c | print_tm()");
}
*/
...
void print_tcstats2_attr(FILE *fp, struct rtattr *rta, char *prefix, struct rtattr **xstats)
{
	...
	printk(KERN_DEBUG "[MAT] tc_util.c | print_tcstats2_attr()");
}
*/
...
compat_xstats:
	...
	printk(KERN_DEBUG "[MAT] tc_util.c | print_tcstats_attr()");
}
*/
